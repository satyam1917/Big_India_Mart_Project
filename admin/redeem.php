...
<body>
    ...
    <center><a href="index.php" class="regis-btn">Admin</a><a href="registered-user.php" class="regis-btn">Registered User</a></center><br>
    <center>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>UPI ID</th>
                    <th>Date</th>
                    <th>Status</th> <!-- Added City column -->
                </tr>
            </thead>
            <tbody>
                <?php
                $query_for_table = "SELECT * FROM `redeem`";
                ...
                while ($row = mysqli_fetch_assoc($result_for_table)) {
                    ...
                    if ($row['status'] == "Not Paid") {
                        echo '<button type="button" class="btn btn-primary" onclick="updateRedeem(' . $row['id'] . ')">Accept Request</button>';
                    }
                    echo '
                                            </div>
                                        </div>
