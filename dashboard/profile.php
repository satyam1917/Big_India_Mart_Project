...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="profile.php" class="active-sub"><i class="fa-solid fa-user"></i> Profile</a></li>
        </ul>
    </div>
    <div class="content">
        ...
        <div class="section">
            ...
            <div class="profile-info">
                <div style="display: flex;"><span>Name: <?php echo $row_for_profile['name'] ?></span></div>
                <div style="display: flex; overflow-wrap: anywhere;"><span>Email: <?php echo $row_for_profile['email'] ?></span></div>
                <div style="display: flex;"><span>Phone: <?php echo $row_for_profile['phone'] ?></span> <button onclick="profile_update('phone')" class="update-btn">Edit</button></div>
                <div style="display: flex;"><span>Address 1:<?php echo $row_for_profile['add1'] ?></span> <button onclick="profile_update('add1')" class="update-btn">Edit</button></div>
                <div style="display: flex;"><span>Address 2: <?php echo $row_for_profile['add2'] ?></span> <button onclick="profile_update('add2')" class="update-btn">Edit</button></div>
                <div style="display: flex;"><span>City: <?php echo $row_for_profile['city'] ?></span> <button onclick="profile_update('city')" class="update-btn">Edit</button></div>
                <div style="display: flex;"><span>Pincode: <?php echo $row_for_profile['pincode'] ?></span> <button onclick="profile_update('pincode')" class="update-btn">Edit</button></div>
                <div style="display: flex;"><span>State: <?php echo $row_for_profile['state'] ?></span> <button onclick="profile_update('state')" class="update-btn">Edit</button></div>
            </div>
        </div>
    </div>
    ...
    <script>
        function profile_update(data) {
            let value = prompt("Enter " + data);
            console.log(value);
            jQuery.ajax({
                url: "profile_update_ajax.php",
                type: "POST",
                data: {
                    field: data,
                    data: value
